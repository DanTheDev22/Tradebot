...
public class Commands {
    ...
    static final String SHOW_ALERTS = "/showalerts";
    static final String DELETE_ALERT = "/deletealert";
    static final String DEFAULT_MESSAGE = "Sorry, I didn't understand that. Try one of the available commands.";
}
